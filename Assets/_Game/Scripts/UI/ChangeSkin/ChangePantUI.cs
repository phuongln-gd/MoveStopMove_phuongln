...
public class ChangePantUI : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        OnInit();
        if (Pref.GetBool(PrefConst.PANT_PREF + i))
        {
    ...
    public void OnDespawn()
    {
        ...
        {
            LevelManager.Ins.player.ChangePant(equipedindex);
        }
    }
    ...
    public void ChangeCurrentItem(int i)
    {
        if (currentItem != i)
        {
            ...
            currentItem = i;
            if (Pref.GetBool(PrefConst.PANT_PREF + currentItem))
            {
    ...
    public void ClickBuyButton()
    {
        if (GameManager.Ins.userData.Gold >= items[currentItem].GetComponent<Item>().price)
        {
            ...
            items[currentItem].GetComponent<Item>().currentState = ItemState.equiped;
            equipedindex = currentItem;
            Pref.SetBool(PrefConst.PANT_PREF + currentItem, true);
